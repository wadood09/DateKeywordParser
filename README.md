...
```bash
Install-Package DateDateKeywordParser
or using the .NET CLI:

dotnet add package DateDateKeywordParser

Usage

using DateKeywordParser;
using System;
...
public class Example
{
    public static void Main(string[] args)
    {
        ...
        string fileName1 = DateKeywordParser.Parse(fileNamePattern1);
        ...
        string fileName2 = DateKeywordParser.Parse(fileNamePattern2, new CultureInfo("fr-CA"));
        ...
        string fileName3 = DateKeywordParser.Parse(fileNamePattern3, "yyyyMMdd");
        ...
        string fileName7 = DateKeywordParser.Parse(fileNamePattern7);
        ...
        string parsedLastWeek = DateKeywordParser.Parse(lastWeekFile);
        ...
        string parsedNextWeek = DateKeywordParser.Parse(nextWeekFile);
        ...
        string parsedLastWeekFR = DateKeywordParser.Parse(lastWeekFileFR, new CultureInfo("fr-CA"));
        ...
        string parsedInvalidPattern1 = DateKeywordParser.Parse(invalidPattern1);
        // Output: Unhandled exception. System.ArgumentException: Invalid expression

        string invalidPattern2 = "file_NOW-15s.log";
        string parsedInvalidPattern2 = DateKeywordParser.Parse(invalidPattern2);
        // Output: Unhandled exception. System.ArgumentException: Invalid expression

        string invalidPattern3 = "file_<NOW-15s-8s>.log";
        string parsedInvalidPattern3 = DateKeywordParser.Parse(invalidPattern3);
        // Output: Unhandled exception. System.FormatException: Duplicate time unit(s): S

        string invalidPattern4 = "file_<NOW-15s-8g>.log";
        string parsedInvalidPattern4 = DateKeywordParser.Parse(invalidPattern4);
        // Output: Unhandled exception. System.ArgumentException: Invalid expression
    }
}
